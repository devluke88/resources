...
| 9 | `docker rmi -f $(docker images -f "dangling=true" -q)` | Remove `<none>` images                                                                                                                                           |
...
| 3  | `docker logs [container_name]`                                                                               | See the container's logs (you can see past logs), but stay in detached mode. Example: `docker logs feedbakc-app`                                                                                                                    |
